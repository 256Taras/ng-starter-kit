...
export class CookieService {
  ...
  public get(name: string): string {
    if (this.documentIsAccessible && this.check(name)) {
      ...
      return result?.length ? this._safeDecodeURIComponent(result[1]) : "";
    } else {
      return "";
    }
  }
  ...
  public getAll(): { [key: string]: string } {
    ...
    if (document.cookie && document.cookie !== "") {
      document.cookie.split(";").forEach((currentCookie: any) => {
        ...
        cookies[this._safeDecodeURIComponent(cookieName.replace(/^ /, ""))] =
  ...
  // eslint-disable-next-line @typescript-eslint/explicit-member-accessibility,no-dupe-class-members
  public set(
    name: string,
    value: string,
    options?: {
  ...
  public set(
    ...
    let cookieString: string = `${encodeURIComponent(
      name
